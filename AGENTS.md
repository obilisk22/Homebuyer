...
| FCC missing-broadband risk (BDC credentials + Form 477 block) | `app/core/fcc_broadband.py` |
...
- [x] TODO-042 missing broadband chip (2026-07-19): optional `FCC_BDC_*` credentials; FCC Geo + Form 477 block lookup; magenta `wifi_off` when no fixed terrestrial service; unknown/no credentials → no chip
...
| `TODO-042` | **Done** | Missing broadband chip (FCC BDC credentials + Form 477 block lookup) |
